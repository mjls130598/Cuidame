...
class ChatActivity : AppCompatActivity() {
    ...
    private lateinit var idSanitario: String
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        idSanitario = intent.getStringExtra("idSanitario")!!
            ...
            if (mensaje != "") {
                ...
                chats.addListenerForSingleValueEvent(object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        ...
                        campos["receptor"] = idSanitario
                        campos["fecha"] = Date().toString()

                        // Si es así, ...
                        if (chatsUsuario.containsKey(idSanitario)) {

                            // Guardamos el nuevo mensaje dentro de él
                            val idChat = chatsUsuario[idSanitario]!!
