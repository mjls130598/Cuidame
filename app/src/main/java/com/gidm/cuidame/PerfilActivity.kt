...
class PerfilActivity : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        nombreUsuario.addValueEventListener(object : ValueEventListener {
    ...
    fun continuarCierre(continuar: Boolean) {
        if (continuar) {
            ...
            // En otras cuentas
            datosUsuario.child("sanitarios").addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    if(sanitariosUsuario != null){
                        for((_, value) in sanitariosUsuario){
                            Utils.borrarSanitario(value, usuario.uid)
                        }
                    }
                }
